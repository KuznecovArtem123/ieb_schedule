...
function MobileBottomNav() {
    ...
    return (
        <nav className="fixed bottom-[max(12px,env(safe-area-inset-bottom))] left-3 right-3 z-10 grid grid-cols-2 gap-1.5 rounded-[22px] bg-surface/95 p-[3px_3px_4px] shadow-nav backdrop-blur" aria-label="Основная навигация">
            <NavLink
